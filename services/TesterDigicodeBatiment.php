...
// Ecrit le 21/5/2015 par Killian

// ce service web est appelé par le lecteur de digicode situé à l'entrée du batiment,
// afin de tester la validité du digicode saisi par l'utilisateur
// Celui-ci doit correspondre au digicode d'une salle réservé à cette heure

// Le service web doit recevoir 1 paramètres : digicode
// Les paramètres peuvent être passés par la méthode GET (pratique pour les tests, mais à éviter en exploitation) :

// http://localhost/reservations/TesterDigicodeBatiment.php?digicode=123456
